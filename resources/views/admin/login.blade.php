        ...
        <div class="relative w-screen h-screen"
            ...
            <div class="relative z-10 flex items-center justify-end h-screen w-screen pr-40">
                <div
                    ...
                    <h3 class="text-sm font-bold mb-10 text-red-500 ">(ADMIN)</h3>
                    ...
                    <form action="{{ route('admin.login') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nip" name="nip" required
                                class=" w-72 border border-gray-300 rounded-md" placeholder="NIP">
                        </div>
                        {{-- <div class="mb-4">
                            <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                            <input type="password" id="password" name="password" required
                                class="mt-1 mb-5 p-2 w-full border border-gray-300 rounded-md" placeholder="Password">
                        </div> --}}
                        <!-- Form Group -->
