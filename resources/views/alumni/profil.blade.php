    ...
    <div class="container mx-full my-10 px-4">
        <div class="mx-auto bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="flex justify-center mb-6">
                <div class="border-2 px-3 py-3 rounded  "> <!-- Menambahkan margin bawah di sini -->
                    <div class="w-36 h-36 rounded  overflow-hidden border-gray-300">
                        <img src="{{ asset('/storage/' . $profil->foto_profil) }}" alt="Foto Profil"
